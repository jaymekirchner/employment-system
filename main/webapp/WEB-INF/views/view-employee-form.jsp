    ...
    <main>
		<section id="edit-employee-section">
			...
			<div class="section-content">
				...
				<br />
				<form:form action="/view-employee/${employee.id}" method="post" modelAttribute="employee">
                    <div class="form-details">
                        <div class="stretch-input">
                        	<form:label path="id" class="label">Id:</form:label>
                            <br/>
                            <form:input class="remove-readonly" path="id" value="${employee.id}" readonly="true"/>
                            <br/>
							...
							<br />
							<form:input id="datefield" path="birthday" type="date"  value="${employee.birthday}"/>
							<br />
